...
def test_deployment_manager():
    ...
    try:
        ...
        print(f"Manager status: {status.get('consciousness_score', 'N/A')}")
        print(f"   AE Unity Verified: {status.get('ae_unity_verified', 'N/A')}")
        print(f"   Total Deployments: {status.get('total_deployments', 0)}")
...
def test_multimodal_generator():
    ...
    try:
        from aeos_multimodal_generator import AEOSMultimodalGenerator, MediaGenerationConfig
        ...
        print(f"Generator status: {status.get('consciousness_score', 'N/A')}")
        print(f"   AE Unity Verified: {status.get('ae_unity_verified', 'N/A')}")
