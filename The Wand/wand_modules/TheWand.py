...
BUILT_IN_PROMPT = r'''{
  ...
  "next_step": {
    ...
    "task": "Implement user-defined functions or other project-specific features."
  },
...
class TheWand:
    def __init__(self):
        ...
        self.core = WandCore(self.config)
    ...
    def _load_config(self):
        ...
        try:
            ...
            print("Configuration file not found. Running initial setup...")
            ensure_system_ready()
            return self._load_config()

    def update_logs(self, message):
        """Called by WandHelper to update GUI logs"""
        if hasattr(self, 'gui'):
            self.gui.update_logs(message)
    
    def start(self):
        print("🚀 Starting AIOS IO Global HPC System")
